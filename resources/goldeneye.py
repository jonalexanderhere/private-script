...
GOLDENEYE_BANNER = 'GoldenEye New Version by Mr.E-Cyber Team and collab with Jan Seidl <jseidl@wroot.org>'
...
USER_AGENT_PARTS = {
    ...
    'platform': {
        ...
        'gecko': {
            'name': ['Gecko/%d%02d%02d Firefox/%d.0' % (random.randint(2001, 2022), random.randint(1,31), random.randint(1,12) , random.randint(10, 25)) for i in range(1, 30)],
            'details': [],
            'extensions': []
        }
    }
